...
// internal
import { Cart, QuickView, Wishlist } from '@/assets/svg';
...
const ProductItem = ({ product, offer_style = false }) => {
  ...
  const isAddedToCart = cart_products.some((prd) => prd._id === slug);
  const isAddedToWishlist = wishlist.some((prd) => prd._id === slug);
