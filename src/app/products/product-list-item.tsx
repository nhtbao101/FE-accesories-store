...
// internal
import { CompareThree, QuickView, Wishlist } from '@/assets/svg';
...
const ShopListItem = (props: Product) => {
  ...
  // handle add product
  const handleAddProduct = (prd: IProduct) => {
    dispatch(add_cart_product(prd));
  };
  // handle wishlist product
  const handleWishlistProduct = (prd: IProduct) => {
    dispatch(add_to_wishlist(prd));
  };

  // handle compare product
  const handleCompareProduct = (prd: IProduct) => {
